      ...
      await getTransporter().sendMail({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:32px;background:#f7fafb;border-radius:12px;">
            ...
            <p style="color:#6B8A9A;font-size:13px;margin-bottom:20px;">⚠️ You'll be asked to change this password on your first login.</p>
            <a href="${siteUrl}/admin" style="display:inline-block;padding:12px 24px;background:#1C2B38;color:#fff;border-radius:8px;text-decoration:none;font-weight:700;font-size:14px;">Go to Admin Dashboard →</a>
          </div>`,
      });
